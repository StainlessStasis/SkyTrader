...
public class SkyTraderTrades {
    ...
    public static final ResourceKey<VillagerTrade> SELL_ENCHANTED_GOLDEN_APPLE = resourceKey("sell_enchanted_golden_apple");
    ...
    public static void bootstrapTrades(BootstrapContext<VillagerTrade> context) {
        ...
        context.register(SELL_SLOW_FALLING_POTION, new VillagerTrade(
                new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.POTION),
                16, 1, 0.05f, Optional.empty(),
        ...
        context.register(SELL_FEATHER_FALLING_BOOK, new VillagerTrade(
                // TODO: random cost
                new TradeCost(Items.EMERALD, 32), new ItemStackTemplate(Items.ENCHANTED_BOOK),
        ...
        context.register(SELL_HAY_BLOCK, new VillagerTrade(
                new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.HAY_BLOCK, 2),
                12, 1, 0.05f, Optional.empty(), List.of()));
        ...
        context.register(SELL_HEART_OF_THE_SEA, new VillagerTrade(
                new TradeCost(Items.EMERALD, 10), new ItemStackTemplate(Items.HEART_OF_THE_SEA),
                1, 30, 0.05f, Optional.empty(), List.of()));
        context.register(SELL_ENCHANTED_GOLDEN_APPLE, new VillagerTrade(
                new TradeCost(Items.EMERALD, 20), new ItemStackTemplate(Items.ENCHANTED_GOLDEN_APPLE),
                1, 30, 0.05f, Optional.empty(), List.of()));
    }
    ...
    public static void bootstrapTradeSets(BootstrapContext<TradeSet> context) {
        ...
        context.register(SKY_TRADER_RARE, new TradeSet(
                HolderSet.direct(
                        ...
                        trades.getOrThrow(SELL_ENCHANTED_GOLDEN_APPLE)
                ),
                UniformGenerator.between(0, 1),
                false,
                Optional.empty()
