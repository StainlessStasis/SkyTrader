...
public class SkyTraderTrades {
    ...
    private static void registerHarnesses(BootstrapContext<VillagerTrade> context) {
        List.of(Items.HARNESS.white(), Items.HARNESS.orange(), Items.HARNESS.magenta(), Items.HARNESS.lightBlue(),
                        Items.HARNESS.yellow(), Items.HARNESS.lime(), Items.HARNESS.pink(), Items.HARNESS.gray(),
                        Items.HARNESS.lightGray(), Items.HARNESS.cyan(), Items.HARNESS.purple(), Items.HARNESS.blue(),
